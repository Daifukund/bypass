  ...
  try {
    ...
    try {
      ...
      return NextResponse.json({ 
        ...
        message: 'Our AI search service is temporarily unavailable. Please try again in a few minutes or try a different company.',
    ...
    const transformedEmployees = employees.map((emp: any, index: number) => {
      ...
      return {
        ...
        title: emp.jobTitle || emp.job_title || emp.title || 'Unknown',
